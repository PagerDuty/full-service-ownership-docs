...
!!! tip
    Before proceeding, it's important to acknowledge the role of digital transformation when implementing service ownership. [Pointy-haired bosses](https://en.wikipedia.org/wiki/Pointy-haired_Boss) will find this section particularly useful. If digital transformation is not your jam, you should [skip to the next section](defining.md).
