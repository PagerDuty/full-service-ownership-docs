...
Often, there are multiple people on the first level—the primary responder and a shadow, who should be observing and learning from the primary responder. As new people join the team, they should have the opportunity to shadow so they can ramp up and be prepared to deal with incidents on their own. At PagerDuty, we practice [shadowing and reverse shadowing](https://thenewstack.io/on-call-heres-how-to-stay-healthy-while-carrying-the-pager/){:target="_blank" }.
